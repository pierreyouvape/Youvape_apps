...
const sendAlertWithAttachments = async (subject, body, attachments = []) => {
  try {
    ...
    console.log('[Alert] Email avec PJ envoyé:', subject);
  } catch (error) {
    console.error('[Alert] Erreur envoi email avec PJ:', error.message);
  }
};

module.exports = { sendAlert, sendAlertWithAttachments };
